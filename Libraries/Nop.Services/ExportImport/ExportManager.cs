    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual void ExportDoanhThuXeToXlsx(Stream stream, List<DoanhThuNhanVienTheoXe> DoanhThuXes, DateTime TuNgay, DateTime DenNgay)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                worksheet.Cells["G4"].Value = "Phí cầu đường";

                worksheet.Cells["H4:H5"].Merge = true;
                worksheet.Cells["H4"].Value = "Phí Nội Bài";

                worksheet.Cells["I4:I5"].Merge = true;
                worksheet.Cells["I4"].Value = "ký nhận";

                worksheet.Cells["K4:K5"].Merge = true;
                worksheet.Cells["K4"].Value = "Ghi chú";
                ...
                foreach (var item in DoanhThuXes)
                {
                    ...
                    worksheet.Cells[row, col].Value = item.PhiCauDuong.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.PhiNoiBai.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = "";
                    col++;

                    worksheet.Cells[row, col].Value = item.SoKhachNoiBai.ToString("###,###") + " khách NB";
                    col++;
